        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="space-y-3">
              ...
              <h3 className="text-xl font-semibold">高品質</h3>
              <p className="text-muted-foreground">精心挑選的優質產品</p>
            </div>
            <div className="space-y-3">
              <div className="w-12 h-12 mx-auto bg-primary/10 rounded-full flex items-center justify-center">
                <svg
              ...
              <h3 className="text-xl font-semibold">最優惠價格</h3>
            ...
            <div className="space-y-3">
              ...
              <h3 className="text-xl font-semibold">快速送達</h3>
              <p className="text-muted-foreground">全球快速可靠的運送服務</p>
            </div>
          </div>
        </div>
      </section>
